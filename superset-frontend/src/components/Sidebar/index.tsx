...
export default function SideBar(props: SideBarProps) {
  ...
  const [chartData, setChartData] = useState<Array<object> | null>(
    null,
  );
        ...
        <SubMenu key="sub1" title={
           ...
           <SubMenu key="sub2" title={
            ...
            .map((chart: any) => (
              <Menu.Item
                ...
                >
                  <a href={chart?.url} data-test={`${chart?.slice_name}-list-chart-title`}>
                    {chart?.certified_by && (
                      <>
                        <CertifiedBadge
          ...
          <SubMenu key="sub3" title={
            ...
            <Menu.Item title="SQL Editor">
              <Link to={`/superset/sqllab/`}>
                    SQL Editor
                  </Link>
            </Menu.Item>
            <Menu.Item title="Saved Queries">
              <Link to={`/savedqueryview/list/`}>
                  Saved Queries
                </Link>
            </Menu.Item>
            <Menu.Item title="Query History">
              <Link to={`/superset/sqllab/history`}>
                Query History
              </Link>
            </Menu.Item>
          </SubMenu>
          ...
          <SubMenu key="sub5" title={
            ...
            <Menu.Item title="Aida (AI Powered Chatbot)">
              <a href="https://aida.aeontsolutions.com/" 
              target="_blank" 
  ...
  return (
    <Sider {...props} user={undefined} width={props.width} className="custom-scrollbar">
      
      
      <Button className="toggle-sidebar-button" onClick={props.toggleSideBarWidth}>
